            ...
            <CustomCard>
              ...
              <DataTable>
                ...
                <DataTable.Row>
                  ...
                  <DataTable.Cell>
                    {name[this.props.vals.ini_symptoms.wheezing]}
                  </DataTable.Cell>
                </DataTable.Row>
                <DataTable.Row>
                  <DataTable.Cell>Shortness of breath</DataTable.Cell>
                  <DataTable.Cell>
                    {name[this.props.vals.ini_symptoms.shortness_of_breath]}
                  </DataTable.Cell>
                </DataTable.Row>
                <DataTable.Row>
                  <DataTable.Cell>Cough</DataTable.Cell>
                  <DataTable.Cell>
                    {name[this.props.vals.ini_symptoms.cough]}
                  </DataTable.Cell>
                </DataTable.Row>
                <DataTable.Row>
                  <DataTable.Cell>Chest Tightness</DataTable.Cell>
                  <DataTable.Cell>
                    {name[this.props.vals.ini_symptoms.chest_tightness]}
                  </DataTable.Cell>
                </DataTable.Row>
                <DataTable.Row>
                  <DataTable.Cell>Night-time Awakening</DataTable.Cell>
                  <DataTable.Cell>
                    {name[this.props.vals.ini_symptoms.nighttime]}
                  </DataTable.Cell>
                </DataTable.Row>
                <DataTable.Row>
                  <DataTable.Cell>Restriction of activity</DataTable.Cell>
                  <DataTable.Cell>
                    {name[this.props.vals.ini_symptoms.restriction]}
                  </DataTable.Cell>
                </DataTable.Row>
              </DataTable>
            ...
            <CustomCard>
              ...
              <DataTable>
                ...
                <View style={{ marginBottom: 18 }}>
                  {!this.props.vals.follow_up.length && (
                    <CustomOverline text="No Symptoms" />
                  )}
                  {!!this.props.vals.follow_up.length &&
                    this.props.vals.follow_up.map((symptom, index) => {
                      return (
                        <>
                          
                            {symptom.symptom.value.length > 1 ? (
                              symptom.symptom.value.map(sym => {
                                return (
                                  <>
                                  <DataTable.Row>
                                    <DataTable.Cell>
                              ...
                              <DataTable.Row>
                                <DataTable.Cell>
                                  {/* {JSON.stringify(symptom.symptom)} */}
                                  {symptom.symptom.value[0].split(",")[0]}
                                </DataTable.Cell>
                                <DataTable.Cell>
                                  {symptom.symptom.value[0].split(",")[1]}
                                </DataTable.Cell>
                                </DataTable.Row>
                              </>
                            )}
